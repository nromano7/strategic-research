...
from elasticsearch_dsl import Document, Date, Nested, Boolean, InnerDoc, Keyword, Text, Float, Integer, Index, analyzer, tokenizer, analysis
import sys
...
if 'projects' in sys.argv:
  ...
  # register a document with the index
  publications.document(Publication)
  # delete the index, ignore if it doesn't exist
